...
import { independentProjects, independentCategories } from '../data/extracurriculars';
...
export default function IndependentProjects() {
  ...
  const filteredPrograms = useMemo(() => {
    return independentProjects.filter(program => {
    ...
    <main className="min-h-screen pt-32 pb-32 px-6 max-w-7xl mx-auto flex flex-col items-center relative z-20">
      ...
      <div className="w-full text-center max-w-4xl mx-auto mb-12">
        ...
        <p className="text-lg md:text-xl text-gray-400 leading-relaxed">
          Design your own impactful extracurriculars. These independent initiatives show initiative, leadership, and require zero financial barriers.
        </p>
      </div>

      {/* Filter Section (Top) */}
      <div className="w-full mb-10 p-6 glass-dark rounded-3xl border border-white/10 shadow-2xl relative z-20">
            ...
            {filteredPrograms.map((program) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4 relative z-10">
                  <span className="px-2.5 py-1 rounded-md text-xs font-bold bg-white/10 text-gray-300 border border-white/20">
                    Self-Directed
                  </span>
