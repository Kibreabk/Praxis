...
import ThreeParticleHero from './components/ThreeParticleHero';
...
function App() {
  return (
    <Router>
      <div className="relative min-h-screen text-white overflow-x-hidden selection:bg-white/30 selection:text-white">
        <ParticleBackground />
        <Navbar />
        <Chatbot />
        <ThreeParticleHero />
